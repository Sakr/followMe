...
<!-- librairie JQuery -->
<script type="text/javascript" src="<c:url value="/resources/js/jquery.fancybox-1.3.4.pack.js"/>"></script>
<!-- script jquery pour les popin -->
<script type="text/javascript" src="<c:url value="/resources/js/lang/datepicker_fr.js"/>"></script>
